...
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_status)
	{
		...
		//ANO_DT_Send_Status(Roll,Pitch,Yaw,baroAlt,0,fly_ready);
                ANO_DT_Send_Status(Data.euler[0]*57.3,Data.euler[1]*57.3,Data.euler[2]*57.3,0,0,0);
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
//		ak8975.Mag_Adc.x,ak8975.Mag_Adc.y,ak8975.Mag_Adc.z,0);
                ANO_DT_Send_Senser(Data.pSensor->accel[0],Data.pSensor->accel[1],Data.pSensor->accel[2],\
                  Data.pSensor->gyro[0],Data.pSensor->gyro[1],Data.pSensor->gyro[2],\
                    0,0,0,0);
...
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid1)
	{
		...
		ANO_DT_Send_PID(1,sp_roll.Kp,sp_roll.Ki,sp_roll.Kd,
					configData[0]/10.0,configData[1]/1000.0,configData[2]/1000.0,
					configData[3]/1000.0,sp_yaw.Ki,sp_yaw.Kd);
	}	
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid2)
	{
...
{
    HAL_UART_Transmit_DMA(&com_port,dataToSend,length);       
}
...
void ANO_DT_Data_Receive_Anl(u8 *data_buf,u8 num)
{
    ...
    {
        configData[4]  = ( (u16)(*(data_buf+4)<<8)|*(data_buf+5) );
        configData[5]= ( (u16)(*(data_buf+6)<<8)|*(data_buf+7) );
        configData[6]= ( (u16)(*(data_buf+8)<<8)|*(data_buf+9) );
        configData[0]=( (u16)(*(data_buf+10)<<8)|*(data_buf+11) );
        configData[1]=( (u16)(*(data_buf+12)<<8)|*(data_buf+13) );
        configData[2]=( (u16)(*(data_buf+14)<<8)|*(data_buf+15) );
        configData[3]=( (u16)(*(data_buf+16)<<8)|*(data_buf+17) );
